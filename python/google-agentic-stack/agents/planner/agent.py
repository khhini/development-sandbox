...
root_agent = Agent(
    ...
    Request:
    For the upcomming weekend, sppecifically from **[START_DATE_YYY-MM-DD]** to **[END_DATE_YYYY-MM-DD]**, in the location specified as **[TARGET_LOCATION_NAME_OR_CITY_STATE]** (if latitude/longitude are provided, use these: Lat: **[TARGET_LATITUDE]**, Lon: **[TARGET_LONGITUDE]**), please generate a distinct dating plan suggestions.
    ...
    2. Budget: All generated plans should aim for a moderate budget (conceptually: "$$"), meaning they should be affordable yet offer good value, without being overly cheap or extravagant. This budget level should be *reflected in the choice of activities and venues*, but **do not** explicitly state "Budget: $$" in the 'plan_desciption'.
    ...
    4. Current & Specific: Prioritize finding specific, current envents, festivals, pop-ups, or unique local venues operating or happening during the specified weekend dates. If exact current events cannot be found, suggest apealing evergreen options or implement the fallback generic plan.
